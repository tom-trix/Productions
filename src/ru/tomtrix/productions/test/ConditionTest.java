...
public class ConditionTest
{
    ...
    {
        Core core = new Core();
        core.addVariable(new Variable("A", VariableType.INFERRIBLE));
        core.addVariable(new Variable("B", VariableType.INFERRIBLE));
        core.addVariable(new Variable("C", VariableType.INFERRIBLE));
